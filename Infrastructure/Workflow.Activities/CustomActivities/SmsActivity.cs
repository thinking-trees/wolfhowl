...
namespace Workflow.Activities.CustomActivities
{
    ...
    public sealed class SmsActivity : CodeActivity
    {
        #region 参数
        /// <summary>
        /// 标识环节类型
        /// </summary>
        private const string ACTIVITY_TYPE = "SmsNotify";
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            ActivityInfo smsAct = actInfoRepository.GetActivity(this.State.Get(context), performAct.WorkflowID);
            //todo...
